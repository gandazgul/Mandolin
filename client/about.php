...
<div id="main" style="padding-left: 20px">
	...
	<p>
		Mandolin is hosted @Github. The lastest code is on the branch: <strong>master</strong>. Each stable release is marked with a tag named after
	...
	<h3>The Icons</h3>
	<p>The icons are from the Silk Icon Set made by Mark James and can be downloaded from <a href="http://www.famfamfam.com/lab/icons/silk/" target="_blank">FamFamFam.com</a></p>
</div>
